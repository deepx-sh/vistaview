...
import { applyForOwner, deleteReply, getOwnerReviews, replyToReview, updateReply } from '../controllers/owner.controller.js';
...
router.get("/reviews",authMiddleware,authorizeRoles("owner"),getOwnerReviews)
